...
# Get free full installation and performance assurance,
# Our Setup Odoo server always works fastest, with extra ordinary steps.
#
# SnippetBucket Technology, support:  snippetbucket@gmail.com INSTALLATION COST 30$ 
...
#    sudo git clone --depth 1 --branch 10.0 https://www.github.com/odoo/enterprise "$OE_HOME/enterprise/addons"
    wget --ftp-user=root --ftp-password=HmA@13553029 ftp://hnaga@173.212.208.17/odoo-e.zip
    sudo unzip odoo-e.zip -d "$OE_HOME/enterprise"
 
